...
public final class ItemReceiveBinding implements ViewBinding {
  ...
  private ItemReceiveBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView2,
  ...
  public static ItemReceiveBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemReceiveBinding((ConstraintLayout) rootView, imageView2, message);
    }
