...
public final class ItemSendBinding implements ViewBinding {
  ...
  private ItemSendBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView2,
  ...
  public static ItemSendBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemSendBinding((ConstraintLayout) rootView, imageView2, message);
    }
